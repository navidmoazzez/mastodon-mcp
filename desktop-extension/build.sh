...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/mastodon-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/mastodon-$version.mcpb"

echo
echo "Built desktop-extension/mastodon-$version.mcpb"
